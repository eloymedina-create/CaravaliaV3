    ...
    >
      ...
      <div className="space-y-3 flex-grow">
        ...
        <div className="border border-caravalia-200 rounded-lg p-3 bg-white shadow-sm mt-3">
          ...
          <div className="text-[11px] text-caravalia-600" style={{ lineHeight: "1.3" }}>
            <p>
            ...
            <p className="mt-2">
              ...
              pago de la señal del 30% del total del importe.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-2 w-full text-center border-t border-caravalia-100 pt-2 mb-2">
        <p className="text-[10px] text-caravalia-500">
          Caravalia es una firma de MyMarket Cor SLU. / CIF: B56133655 / Ingeniero Barbudo, 18 / 14013 / Córdoba / Tfno:
          957614918
        </p>
      </div>
    </div>
