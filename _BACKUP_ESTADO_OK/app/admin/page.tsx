            ...
            <Link href="/configuracion" className="group">
              <div className="bg-[#e7e8e7] p-8 rounded-[2.5rem] h-full flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-sm">
                <div>
                  ...
                  <h3 className="font-headline font-black text-2xl text-[#191C1C] leading-tight mb-2">Gestión de Usuarios</h3>
                  <p className="text-[#191C1C]/70 text-sm font-medium">Administra los miembros del equipo y sus PINs personales de seguridad.</p>
                </div>
